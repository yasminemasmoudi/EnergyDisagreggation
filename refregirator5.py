...
@flow(name="refregirator main flow")
def main_flow():
    labels = read_label()
    for i in range(1,3):
    ...
    model_2 = load_model('models/fc_refrigerator_5_h1_2.hdf5', custom_objects={"f1_m": f1_m, "precision_m": precision_m, "recall_m": recall_m})
