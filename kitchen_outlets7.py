...
@flow(name="kitchen outlets main flow")
def main_flow():
    labels = read_label()
    for i in range(1,3):
    ...
    y_train2 = df1_train['kitchen_outlets_7'].values
    X_val2 = df1_val[['mains_1','mains_2']].values
    y_val2 = df1_val['kitchen_outlets_7'].values
    X_test2 = df1_test[['mains_1','mains_2']].values
    y_test2 = df1_test['kitchen_outlets_7'].values


    # model_2 = build_fc_model()
    # hist_2 = train_model("models/refrigerator_5_h1_2.hdf5",model_2,X_train2,y_train2)
    ...
    model_2 = load_model('models/fc_kitchen_outlets_7_h1_2.hdf5', custom_objects={"f1_m": f1_m, "precision_m": precision_m, "recall_m": recall_m})
    ...
    mlflow.sklearn.log_model(model_2, "kitchen_outlets_model")
